...
S3App.submitPost = function() {
  ...
  //debugger;
  $.ajax({
    url: 'https://thawing-badlands-6637.herokuapp.com/posts',
    type: 'POST',
...
S3App.getMessage = function(postId){
  $.ajax({
    url: 'https://thawing-badlands-6637.herokuapp.com/posts/' + postId,
    type: 'GET',
  })
  .done(function(data) {
...
S3App.getKey = function(id){
  $.ajax({
    url: 'https://thawing-badlands-6637.herokuapp.com/amazon/sign_key',
    type: 'GET',
    dataType: 'JSON',
  })
  .done(function(data) {
...
S3App.sendUrlToDb = function(id, key){
  ...
  //debugger;
  $.ajax({
    url: 'https://thawing-badlands-6637.herokuapp.com/posts/' + id + '/images' ,
    type: 'POST',
